...
const Login = () => {
  ...
  return (
    <div className="bg-white h-[100vh] w-full flex justify-between items-center">
      <img
        className="w-0 lg:w-[60%] h-[100vh] object-cover"
        ...
        alt=""
      />
      <div className="w-100 lg:w-[40%] flex justify-center items-start flex-col pl-8">
        ...
        >
          ...
          <div className="flex flex-col w-full pr-5 mt-3">
          ...
          <div className="flex gap-2 w-[70%] mt-3 justify-start items-center">
